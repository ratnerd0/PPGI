...
XTCAV_noise = 5e-2   # rms noise on XTCAV
spec_noise = 10e-1   # noise fraction on spectrometer
n_elec = 10          # number of electrons measured
N_samp = -1
...
t_samp=np.arange(0,len(t_sase),24)    # downsample time resolution
...
#----------
# R_est
savename='figs/AMO/R_est_%delec_%0.1ffsec_%dnoise.png' % (n_elec,XTCAV_FWHM,XTCAV_noise*100)
